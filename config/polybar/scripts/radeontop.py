...
class radeontop:
    def __init__(self):
        ...
        output = Komi.communicate()[0].decode('utf-8')
        output = output.split("\n")[2]
...
if __name__ == "__main__":
    ...
    format_string = f"󰢮 {result['gpu'][0][0]}%"
    print(format_string)

# --------------------------------------------------------------------------------------- #
# - Script taken from https://github.com/EmiliaTheGoddess/polybar-radeontop/tree/master - #
# --------------------------------------------------------------------------------------- #
